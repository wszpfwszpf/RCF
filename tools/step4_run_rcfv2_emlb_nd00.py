...
from rcf_fast.rcf_corev2 import rcf_process_bin
...
# Output directories
OUT_DIR = r"C:\Users\93084\Desktop\自己论文写作\2.降噪\RCF\data\emlb_rcfv2_verify"
...
def main():
    ...
    cfg = RCFComputeConfigv2(bin_us=BIN_MS * 1000)
