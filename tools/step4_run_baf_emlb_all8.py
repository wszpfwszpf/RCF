# tools/step4_run_baf_emlb_all8.py
# Run full E-MLB (8 subsets): {day, night} x {ND00, ND04, ND16, ND64}
# - stream aedat4
# - slice into BIN_MS chunks (batching only; BAF is event-driven)
...
def run_one_subset(split: str, nd: str, cfg: BAFComputeConfig, csv_dir: str, keep_dir: str):
    ...
    print(f"[STEP4-BAF] Subset: {split}/{nd} | files={len(files)}")

    out_csv = os.path.join(csv_dir, f"baf_profile_{split}_{nd.lower()}.csv")
...
def main():
    ...
    print("=" * 110)
    print("[STEP4-BAF] Full E-MLB run (8 subsets): day/night x ND00/ND04/ND16/ND64")
    print(f"[STEP4-BAF] Data base : {DATA_ROOT_BASE}")
    ...
    print("=" * 110)
    print("[STEP4-BAF] All done.")
    print(f"[STEP4-BAF] CSV dir    : {csv_dir}")
