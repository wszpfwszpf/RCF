# tools/step4_dwf_mesr_rr_all8.py
# 日期：2026-01-08
# 中文说明：
# 在 E-MLB 的 8 个子集（day/night × ND00/04/16/64）上统计 DWF 的 ESR 与 RR。
...
OUT_DIR = Path(r"../baselines/step4_dwf_mesr_rr_all8")
OUT_CSV = OUT_DIR / "dwf_mesr_rr_all8_filemean.csv"
